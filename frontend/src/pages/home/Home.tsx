...
const cards = [
  { key: 'vocabularies', label: '词汇', path: '/w/words/vocabularies' },
  { key: 'collections', label: '集合', path: '/w/words/collections' },
  { key: 'grammars', label: '语法', path: '/w/words/grammars' },
  { key: 'sentences', label: '句子', path: '/w/words/sentences' },
] as const;
    ...
    <VStack align="stretch" spacing={7}>
      ...
      <Card bg="brand.100">
        <CardBody>
          ...
          <Button as={Link} to="/w/words/collections" mt={5}>
            查看集合
          </Button>
        </CardBody>
      </Card>
